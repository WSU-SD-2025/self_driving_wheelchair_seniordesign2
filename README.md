...
3. Ensure the following folders exist and create them if they do not. The folders do not need anything in them.
  a. /meshes
  b. /rviz
  c. /urdf
4. Navigate to /ros2_ws/src/ and then delete the folder /ldrobot-lidar-ros2/.
5. execute the command "git clone https://github.com/Myzhar/ldrobot-lidar-ros2.git" to ensure you have the latest copy of the libraries.
